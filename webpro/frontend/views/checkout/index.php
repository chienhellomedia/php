    ...
    <?php $form = ActiveForm::begin([
      ...
      <?php else : ?>
        <div class="row">
          <div class="col-md-3">  
            <?php if (isset(Yii::$app->user->identity->id)): ?>
              ...
              'class'=>'form-control unicase-form-control text-input']) ?>
              <?= $form->field($model, 'addess')->textInput() ?>
        ...
        <div class="col-md-3">
          ...
          <?= $form->field($model, 'total')->hiddenInput(['value'=>$cost, 'class'=>'form-control unicase-form-control text-input'])->label(false) ?>
