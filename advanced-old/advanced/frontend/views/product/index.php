              ...
              <div class="cart clearfix animate-effect">
                <div class="action">
                 ...
                 <li class="lnk">
                  ...
                  data-name="<?php echo $val->name; ?>"
                  href="<?php echo Url::to(['/compare/addcompare', 'id' =>$val->id]) ?>" title="So sánh">
    ...
    <div class="category-product-inner wow fadeInUp">
     <div class="products">        
       ...
       <div class="col col-sm-8 col-lg-8">
        ...
        <li class="lnk">
          <a class="add-to-cart add-compare" 
          href="<?php echo Url::to(['compare/addcompare', 'id'=>$val->id]) ?>" data-name="<?php echo $val->name ?>" title="So sánh">
            <i class="fa fa-signal"></i>
          </a>
        </li>
      </ul>
