 ...
 */
class PriceListController extends MainController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                ...
                Yii::$app->session->setFlash('danger', 'Tạo mới không thành công.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                ...
                Yii::$app->session->setFlash('danger', 'Sửa không thành công.');
