...
//danh cho quan ly the loai
 ...
 function danhsachloaitin(){
 	$qr ="
 	SELECT l.idLT,l.Ten, l.Ten_KhongDau, l.ThuTu, l.AnHien, t.TenTL FROM loaitin as l JOIN theloai as t on l.idTL = t.idTL order by idLT DESC
 	"; 
 	return mysql_query($qr);
 }
