...
<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 150px; overflow: hidden;">
    <?php 
    $quangcaoduoi = QuangCaoduoi();
    while ($row_quangcaoduoi = mysql_fetch_array($quangcaoduoi)) {       

        ?>
        <div><img u="image" src="upload/quangcao/<?php echo $row_quangcaoduoi['urlHinh']; ?>" /></div>
        <?php 
    }
    ?>
