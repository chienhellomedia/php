		...
		<div class="col-md-3">
			<form action="" method="POST" role="form">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="" name="MaSP" placeholder="Input field">
				</div>	
				<div class="form-group">
					<label for="">TenSP</label>
					<input type="text" class="form-control" id="" name="TenSP" placeholder="Input field">
				</div>	
				<div class="form-group">
					<label for="">Mau</label>
				...
				<input type="submit" name="submit-btn" value="Thêm">
			</form>
			<?php 
			...
			if(isset($_POST['submit-btn']))
			{
				...
				if($MaSp && $TenSp && $Mau && $GiaSp){
					$sql = "INSERT INTO my_table (id,TenSP, Mau, Gia)";
					$sql .= "VALUES('$MaSp','$TenSp', '$Mau', '$GiaSp')";
